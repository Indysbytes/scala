...
class WebConfig {
  ...
  @BeanProperty
  var projectArtifactId: String = "this.is.from.WebConfig.1"

  @Value("#{environment['maven.project.groupId']}")
  @BeanProperty
  var projectGroupId: String = "this.is.from.WebConfig.2"

  @Value("#{environment['maven.project.version']}")
  @BeanProperty
  var projectVersion: String = "this.is.from.WebConfig.3"
