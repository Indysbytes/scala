...
import com.indy.rentor.repository.CustomerRepository
...
import com.indy.rentor.controller.ControllerTools
...
class CustomerController {
    ...
    def createNewCustomer(   @Valid @ModelAttribute("customerData") customerData: CustomerPageData, bindingResult: BindingResult): String = {
